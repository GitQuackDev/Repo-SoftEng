...
import { LayoutDashboard, MessageSquare, BrainCircuit, BookOpen, List, Settings, LogOut, GraduationCap } from 'lucide-react'
  ...
  return (
    <>
      ...
      >
        ...
        <button onClick={handleLogout} className="flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-sky-600 hover:bg-sky-700 text-white font-semibold shadow-md transition-all duration-300 mb-4 mx-4 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"> <LogOut className="w-5 h-5" /> <span className="hidden md:inline">Logout</span> </button>
      </aside>
    </>
  )
}
